...
class Scoreboard():
    ...
    def __init__(self, settings, screen, stats):
        ...
        self.life_emblem_image = pygame.transform.scale(ship_image, settings.life_emblem_dimensions)
    ...
    def refresh_score_surface(self):
        ...
        self.score_image = self.font.render(score, True, self.settings.scoreboard_text_color)
    ...
    def refresh_high_score_surface(self):
        ...
        self.high_score_image = self.font.render(high_score, True, self.settings.scoreboard_text_color)
    ...
    def refresh_level_surface(self):
        ...
        self.level_image = self.font.render(level, True, self.settings.scoreboard_text_color)
    ...
    def refresh_lives_surface(self):
        ...
        self.lives_image = pygame.Surface((self.settings.life_emblem_width * self.stats.lives, self.settings.life_emblem_height))
