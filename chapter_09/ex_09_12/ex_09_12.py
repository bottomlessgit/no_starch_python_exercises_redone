# Demonstrates use of imports from multiple modules
import user
import privileges
import admin
...
privileges = privileges.Privileges(admin_privileges)
admin1 = admin.Admin("vermin", "supreme", "vsauce", "06/06/1960", True, 
